...
<div style="margin-left: 80px">
    <div class="z-formrow">
        {formlabel for='weeklyObjectType' __text='Object type'}
            {weeklyObjectTypeSelector assign='allObjectTypes'}
            {formdropdownlist id='weeklyObjectType' dataField='objectType' group='data' mandatory=true items=$allObjectTypes}
    ...
    <div{* class="z-formrow"*}>
        ...
        {weeklyItemSelector id='id' group='data' objectType=$objectType}
    </div>
