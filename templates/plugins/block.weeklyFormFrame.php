...
/**
 * The weeklyFormFrame plugin adds styling <div> elements and a validation summary.
 *
 ...
 */
function smarty_block_weeklyFormFrame($params, $content, $view)
{
    ...
    $result .= $view->registerBlock('Weekly_Form_Plugin_FormFrame', $params, $content);
