...
/**
 * The weeklyTemplateHeaders plugin performs header() operations
 ...
 */
function smarty_function_weeklyTemplateHeaders($params, $view)
{
    if (!isset($params['contentType'])) {
        $view->trigger_error($view->__f('%1$s: missing parameter \'%2$s\'', array('weeklyTemplateHeaders', 'contentType')));
    }
