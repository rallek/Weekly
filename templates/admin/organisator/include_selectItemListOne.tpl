{* purpose of this template: inclusion template for display of related organisator in admin area *}
...
{if isset($item) && is_array($item) && isset($item[0]) && !is_object($item[0])}
    {modapifunc modname='Weekly' type='selection' func='getEntity' objectType='organisator' id=$item[0] assign='item'}
{/if}
