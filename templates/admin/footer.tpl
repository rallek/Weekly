...
{if !isset($smarty.get.theme) || $smarty.get.theme ne 'Printer'}
    <p class="z-center">
        Powered by <a href="http://modulestudio.de" title="Get the MOST out of Zikula!">ModuleStudio 0.6.1</a> and created by Ralf!
    </p>
    {adminfooter}
{elseif isset($smarty.get.func) && $smarty.get.func eq 'edit'}
    {pageaddvar name='stylesheet' value='style/core.css'}
    {pageaddvar name='stylesheet' value='modules/Weekly/style/style.css'}
