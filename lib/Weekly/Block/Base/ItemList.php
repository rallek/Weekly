 ...
 */
class Weekly_Block_Base_ItemList extends Zikula_Controller_AbstractBlock
{
    /**
    ...
    {
        SecurityUtil::registerPermissionSchema('Weekly:ItemListBlock:', 'Block title::');
    }
    ...
    public function info()
    {
        ...
        if (!ModUtil::available('Weekly')) {
            $requirementMessage .= $this->__('Notice: This block will not be displayed until you activate the Weekly module.');
        }
    
        return array('module'          => 'Weekly',
                     'text_type'       => $this->__('Weekly list view'),
                     'text_type_long'  => $this->__('Display list of Weekly objects.'),
                     'allow_multiple'  => true,
                     'form_content'    => false,
                     'form_refresh'    => false,
                     'show_preview'    => true,
    ...
    public function display($blockinfo)
    {
        ...
        if (!SecurityUtil::checkPermission('Weekly:ItemListBlock:', "$blockinfo[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        if (empty($blockinfo['title'])) {
            $blockinfo['title'] = $this->__('Weekly items');
        }
    ...
    protected function getSortParam($vars, $repository)
    {
        ...
        if ($vars['sorting'] == 'newest') {
            $idFields = ModUtil::apiFunc('Weekly', 'selection', 'getIdFields', array('ot' => $vars['objectType']));
            if (count($idFields) == 1) {
    ...
    public function update($blockinfo)
    {
        ...
        $vars['objectType'] = $this->request->request->filter('objecttype', 'event', FILTER_SANITIZE_STRING);
