 ...
 */
class Weekly_ContentType_Base_ItemList extends Content_AbstractContentType
{
    /**
    ...
    public function getTitle()
    {
        ...
        return __('Weekly list view', $dom);
    }
    ...
    public function getDescription()
    {
        ...
        return __('Display list of Weekly objects.', $dom);
    }
    ...
    public function display()
    {
        ...
        $this->view->toplevelmodule = 'Weekly';
    
        $this->view->setCaching(Zikula_View::CACHE_ENABLED);
        // set cache id
        $component = 'Weekly:' . ucwords($this->objectType) . ':';
        $instance = '::';
    ...
    protected function getSortParam($repository)
    {
        ...
        if ($this->sorting == 'newest') {
            $idFields = ModUtil::apiFunc('Weekly', 'selection', 'getIdFields', array('ot' => $this->objectType));
            if (count($idFields) == 1) {
    ...
    public function startEditing()
    {
        ...
        array_push($this->view->plugins_dir, 'modules/Weekly/templates/plugins');
    }
}
