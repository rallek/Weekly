 ...
 */
class Weekly_Controller_Base_Admin extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
    ...
    public function view()
    {
        ...
        $objectType = $this->request->query->filter('ot', 'event', FILTER_SANITIZE_STRING);
        ...
        $viewHelper = new Weekly_Util_View($this->serviceManager);
        ...
        $modelHelper = new Weekly_Util_Model($this->serviceManager);
    ...
    public function handleSelectedEntries()
    {
        ...
        $workflowHelper = new Weekly_Util_Workflow($this->serviceManager);
    ...
    public function config()
    {
        ...
        // Execute form using supplied template and page event handler
        return $view->execute($templateName, new Weekly_Form_Handler_Admin_Config());
    }
}
