 ...
 */
class Weekly_Listener_Base_User
{
    /**
    ...
    public static function delete(Zikula_Event $event)
    {
        ...
        $repo = $entityManager->getRepository('Weekly_Entity_Event');
        ...
        $repo = $entityManager->getRepository('Weekly_Entity_Kind');
        // delete all kind created by this user
        $repo->deleteCreator($uid);
        // note you could also do: $repo->updateCreator($uid, 2);
        
        // set last editor to admin (2) for all kind updated by this user
        $repo->updateLastEditor($uid, 2);
        // note you could also do: $repo->deleteLastEditor($uid);
        
        $repo = $entityManager->getRepository('Weekly_Entity_Location');
