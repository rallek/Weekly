 ...
 * @abstract
 */
abstract class Weekly_Entity_Base_Location extends Zikula_EntityAccess
{
    /**
    ...
    /**
     * @var Weekly_Entity_Validator_Location The validator for this entity.
     */
    ...
    /**
     * Location picture meta data array.
     *
     * @ORM\Column(type="array")
     * @var array $locationPictureMeta.
     */
    protected $locationPictureMeta = array();
    
    /**
     * @ORM\Column(length=255)
     * @var string $locationPicture.
     */
    protected $locationPicture = '';
    
    /**
     * The full path to the location picture.
     *
     * @var string $locationPictureFullPath.
     */
    protected $locationPictureFullPath = '';
    
    /**
     * Full location picture path as url.
     *
     * @var string $locationPictureFullPathUrl.
     */
    protected $locationPictureFullPathUrl = '';
    ...
    /**
     * Bidirectional - One location [location] has many event [events] (INVERSE SIDE).
     *
     * @ORM\OneToMany(targetEntity="Weekly_Entity_Event", mappedBy="location", cascade={"persist"})
     * @ORM\JoinTable(name="weekly_locationevent")
     ...
     * Get _validator.
     *
     * @return Weekly_Entity_Validator_Location
     */
     ...
     * Set _validator.
     *
     * @param Weekly_Entity_Validator_Location $_validator.
     *
     * @return void
     */
    public function set_validator(Weekly_Entity_Validator_Location $_validator = null)
    {
     ...
     * Set location text.
     *
     * @param text $locationText.
     *
     * @return void
     */
    public function setLocationText($locationText)
    {
        if ($locationText != $this->locationText) {
    ...
    {
        if ($locationPicture != $this->locationPicture) {
            $this->locationPicture = $locationPicture;
        }
    }
    
    /**
     * Get location picture full path.
     *
     * @return string
     */
    public function getLocationPictureFullPath()
    {
        return $this->locationPictureFullPath;
    }
    
    /**
     * Set location picture full path.
     *
     * @param string $locationPictureFullPath.
     *
     * @return void
     */
    public function setLocationPictureFullPath($locationPictureFullPath)
    {
        if ($locationPictureFullPath != $this->locationPictureFullPath) {
            $this->locationPictureFullPath = $locationPictureFullPath;
        }
    }
    
    /**
     * Get location picture full path url.
     *
     * @return string
     */
    public function getLocationPictureFullPathUrl()
    {
        return $this->locationPictureFullPathUrl;
    }
    
    /**
     * Set location picture full path url.
     *
     * @param string $locationPictureFullPathUrl.
     *
     * @return void
     */
    public function setLocationPictureFullPathUrl($locationPictureFullPathUrl)
    {
        if ($locationPictureFullPathUrl != $this->locationPictureFullPathUrl) {
            $this->locationPictureFullPathUrl = $locationPictureFullPathUrl;
        }
    }
    
    /**
     * Get location picture meta.
     *
     * @return array
     */
    public function getLocationPictureMeta()
    {
        return $this->locationPictureMeta;
    }
    
    /**
     * Set location picture meta.
     *
     * @param array $locationPictureMeta.
     *
     * @return void
     */
    public function setLocationPictureMeta($locationPictureMeta = Array())
    {
        if ($locationPictureMeta != $this->locationPictureMeta) {
            $this->locationPictureMeta = $locationPictureMeta;
        }
    }
     ...
     *
     * @return Weekly_Entity_Validator_Location The validator for this entity.
     */
    public function initValidator()
    {
        ...
        $this->_validator = new Weekly_Entity_Validator_Location($this);
    ...
    protected function prepareItemActions()
    {
        ...
        if ($currentType == 'admin') {
            if (in_array($currentFunc, array('main', 'view'))) {
                $this->_actions[] = array(
                    'url' => array('type' => 'user', 'func' => 'display', 'arguments' => array('ot' => 'location', 'id' => $this['id'])),
                    'icon' => 'preview',
                    'linkTitle' => __('Open preview page', $dom),
                    'linkText' => __('Preview', $dom)
                );
                $this->_actions[] = array(
                    'url' => array('type' => 'admin', 'func' => 'display', 'arguments' => array('ot' => 'location', 'id' => $this['id'])),
                    'icon' => 'display',
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                $component = 'Weekly:Location:';
                $instance = $this->id . '::';
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_EDIT)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'location', 'id' => $this['id'])),
                        'icon' => 'edit',
                        'linkTitle' => __('Edit', $dom),
                        'linkText' => __('Edit', $dom)
                    );
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'location', 'astemplate' => $this['id'])),
                        'icon' => 'saveas',
            ...
            if ($currentFunc == 'display') {
                $this->_actions[] = array(
                    'url' => array('type' => 'admin', 'func' => 'view', 'arguments' => array('ot' => 'location')),
                    'icon' => 'back',
            ...
            if ($authAdmin || (isset($uid) && isset($this->createdUserId) && $this->createdUserId == $uid)) {
                ...
                $urlArgs = array('ot' => 'event',
                                 'location' => $this->id);
                if ($currentFunc == 'view') {
                    $urlArgs['returnTo'] = 'adminViewLocation';
                } elseif ($currentFunc == 'display') {
                    $urlArgs['returnTo'] = 'adminDisplayLocation';
                }
                $this->_actions[] = array(
        ...
        if ($currentType == 'user') {
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                ...
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_EDIT)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'edit', 'arguments' => array('ot' => 'location', 'id' => $this['id'])),
                        'icon' => 'edit',
                        'linkTitle' => __('Edit', $dom),
                        'linkText' => __('Edit', $dom)
                    );
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'edit', 'arguments' => array('ot' => 'location', 'astemplate' => $this['id'])),
                        'icon' => 'saveas',
                        'linkTitle' => __('Reuse for new item', $dom),
                        'linkText' => __('Reuse', $dom)
                    );
            ...
            if ($currentFunc == 'display') {
                $this->_actions[] = array(
                    'url' => array('type' => 'user', 'func' => 'view', 'arguments' => array('ot' => 'location')),
                    'icon' => 'back',
                    'linkTitle' => __('Back to overview', $dom),
                    'linkText' => __('Back to overview', $dom)
                );
            ...
            if ($authAdmin || (isset($uid) && isset($this->createdUserId) && $this->createdUserId == $uid)) {
                ...
                $urlArgs = array('ot' => 'event',
                                 'location' => $this->id);
                if ($currentFunc == 'view') {
                    $urlArgs['returnTo'] = 'userViewLocation';
                } elseif ($currentFunc == 'display') {
                    $urlArgs['returnTo'] = 'userDisplayLocation';
                }
                $this->_actions[] = array(
    ...
    {
        return 'weekly.ui_hooks.locations';
    }
     ...
     *
     * @see Weekly_Entity_Location::postLoadCallback()
    ...
    protected function performPostLoadCallback()
    {
        ...
        $this->formatTextualField('locationName', $currentFunc, $usesCsvOutput);
        $this->formatTextualField('locationText', $currentFunc, $usesCsvOutput);
        if (!empty($this['locationPicture'])) {
            try {
                $basePath = $controllerHelper->getFileBaseFolder('location', 'locationPicture');
            } catch (\Exception $e) {
                return LogUtil::registerError($e->getMessage());
            }
        
            $fullPath = $basePath .  $this['locationPicture'];
            $this['locationPictureFullPath'] = $fullPath;
            $this['locationPictureFullPathURL'] = System::getBaseUrl() . $fullPath;
        
            // just some backwards compatibility stuff
            /*if (!isset($this['locationPictureMeta']) || !is_array($this['locationPictureMeta']) || !count($this['locationPictureMeta'])) {
                // assign new meta data
                $this['locationPictureMeta'] = $uploadManager->readMetaDataForFile($this['locationPicture'], $fullPath);
            }*/
        }
     ...
     *
     * @see Weekly_Entity_Location::prePersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no access to entity manager or unit of work apis
     *
     * @see Weekly_Entity_Location::postPersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see Weekly_Entity_Location::preRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL DELETE statement
     *
     * @see Weekly_Entity_Location::postRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
    protected function performPostRemoveCallback()
    {
        ...
        $uploadFields = array('locationPicture');
        foreach ($uploadFields as $uploadField) {
            ...
            $uploadManager->deleteUploadFile('location', $this, $uploadField, $objectId);
        }
     ...
     *     - no creation of other entities allowed
     *
     * @see Weekly_Entity_Location::preUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL UPDATE statement
     *
     * @see Weekly_Entity_Location::postUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see Weekly_Entity_Location::preSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     * For more information see corresponding callback handlers.
     *
     * @see Weekly_Entity_Location::postSaveCallback()
     * @return boolean true if completed successfully else false.
     */
    ...
    public function __clone()
    {
        ...
        if ($this->id) {
            ...
            $entity = new \Weekly_Entity_Location();
            // unset identifiers
            $entity->setId(null);
            // copy simple fields
            ...
            $entity->setLocationName($this->getLocationName());
            $entity->setLocationText($this->getLocationText());
            $entity->setLocationPicture($this->getLocationPicture());
