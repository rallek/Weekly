 ...
 *
 * This is the base entity class for kind entities.
 *
 * @abstract
 */
abstract class Weekly_Entity_Base_Kind extends Zikula_EntityAccess
{
    /**
     * @var string The tablename this object maps to.
     */
    protected $_objectType = 'kind';
    
    /**
     * @var Weekly_Entity_Validator_Kind The validator for this entity.
     */
    ...
    /**
     * Kind picture meta data array.
     *
     * @ORM\Column(type="array")
     * @var array $kindPictureMeta.
     */
    protected $kindPictureMeta = array();
    
    /**
     * @ORM\Column(length=255)
     * @var string $kindPicture.
     */
    protected $kindPicture = '';
    
    /**
     * The full path to the kind picture.
     *
     * @var string $kindPictureFullPath.
     */
    protected $kindPictureFullPath = '';
    
    /**
     * Full kind picture path as url.
     *
     * @var string $kindPictureFullPathUrl.
     */
    protected $kindPictureFullPathUrl = '';
    ...
    /**
     * Bidirectional - One kind [kind] has many event [events] (INVERSE SIDE).
     *
     * @ORM\OneToMany(targetEntity="Weekly_Entity_Event", mappedBy="kind", cascade={"persist"})
     * @ORM\JoinTable(name="weekly_kindevent")
     ...
     * Get _validator.
     *
     * @return Weekly_Entity_Validator_Kind
     */
     ...
     * Set _validator.
     *
     * @param Weekly_Entity_Validator_Kind $_validator.
     *
     * @return void
     */
    public function set_validator(Weekly_Entity_Validator_Kind $_validator = null)
    {
     ...
     * @return void
     */
    public function setKindText($kindText)
    {
        if ($kindText != $this->kindText) {
     ...
     * @return string
     */
    public function getKindPicture()
    {
        return $this->kindPicture;
    }
    
    /**
     * Set kind picture.
     *
     * @param string $kindPicture.
     *
     * @return void
     */
    public function setKindPicture($kindPicture)
    {
        if ($kindPicture != $this->kindPicture) {
            $this->kindPicture = $kindPicture;
        }
    }
    
    /**
     * Get kind picture full path.
     *
     * @return string
     */
    public function getKindPictureFullPath()
    {
        return $this->kindPictureFullPath;
    }
    
    /**
     * Set kind picture full path.
     *
     * @param string $kindPictureFullPath.
     *
     * @return void
     */
    public function setKindPictureFullPath($kindPictureFullPath)
    {
        if ($kindPictureFullPath != $this->kindPictureFullPath) {
            $this->kindPictureFullPath = $kindPictureFullPath;
        }
    }
    
    /**
     * Get kind picture full path url.
     *
     * @return string
     */
    public function getKindPictureFullPathUrl()
    {
        return $this->kindPictureFullPathUrl;
    }
    
    /**
     * Set kind picture full path url.
     *
     * @param string $kindPictureFullPathUrl.
     *
     * @return void
     */
    public function setKindPictureFullPathUrl($kindPictureFullPathUrl)
    {
        if ($kindPictureFullPathUrl != $this->kindPictureFullPathUrl) {
            $this->kindPictureFullPathUrl = $kindPictureFullPathUrl;
        }
    }
    
    /**
     * Get kind picture meta.
     *
     * @return array
     */
    public function getKindPictureMeta()
    {
        return $this->kindPictureMeta;
    }
    
    /**
     * Set kind picture meta.
     *
     * @param array $kindPictureMeta.
     *
     * @return void
     */
    public function setKindPictureMeta($kindPictureMeta = Array())
    {
        if ($kindPictureMeta != $this->kindPictureMeta) {
            $this->kindPictureMeta = $kindPictureMeta;
        }
    }
     ...
     *
     * @return Weekly_Entity_Validator_Kind The validator for this entity.
     */
    public function initValidator()
    {
        ...
        $this->_validator = new Weekly_Entity_Validator_Kind($this);
    ...
    protected function prepareItemActions()
    {
        ...
        if ($currentType == 'admin') {
            if (in_array($currentFunc, array('main', 'view'))) {
                $this->_actions[] = array(
                    'url' => array('type' => 'user', 'func' => 'display', 'arguments' => array('ot' => 'kind', 'id' => $this['id'])),
                    'icon' => 'preview',
                    'linkTitle' => __('Open preview page', $dom),
                    'linkText' => __('Preview', $dom)
                );
                $this->_actions[] = array(
                    'url' => array('type' => 'admin', 'func' => 'display', 'arguments' => array('ot' => 'kind', 'id' => $this['id'])),
                    'icon' => 'display',
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                $component = 'Weekly:Kind:';
                $instance = $this->id . '::';
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_EDIT)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'kind', 'id' => $this['id'])),
                        'icon' => 'edit',
                        'linkTitle' => __('Edit', $dom),
                        'linkText' => __('Edit', $dom)
                    );
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'kind', 'astemplate' => $this['id'])),
                        'icon' => 'saveas',
            ...
            if ($currentFunc == 'display') {
                $this->_actions[] = array(
                    'url' => array('type' => 'admin', 'func' => 'view', 'arguments' => array('ot' => 'kind')),
                    'icon' => 'back',
            ...
            if ($authAdmin || (isset($uid) && isset($this->createdUserId) && $this->createdUserId == $uid)) {
                ...
                $urlArgs = array('ot' => 'event',
                                 'kind' => $this->id);
                if ($currentFunc == 'view') {
                    $urlArgs['returnTo'] = 'adminViewKind';
                } elseif ($currentFunc == 'display') {
                    $urlArgs['returnTo'] = 'adminDisplayKind';
                }
                $this->_actions[] = array(
        ...
        if ($currentType == 'user') {
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                ...
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_EDIT)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'edit', 'arguments' => array('ot' => 'kind', 'id' => $this['id'])),
                        'icon' => 'edit',
                        'linkTitle' => __('Edit', $dom),
                        'linkText' => __('Edit', $dom)
                    );
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'edit', 'arguments' => array('ot' => 'kind', 'astemplate' => $this['id'])),
                        'icon' => 'saveas',
                        'linkTitle' => __('Reuse for new item', $dom),
                        'linkText' => __('Reuse', $dom)
                    );
            ...
            if ($currentFunc == 'display') {
                $this->_actions[] = array(
                    'url' => array('type' => 'user', 'func' => 'view', 'arguments' => array('ot' => 'kind')),
                    'icon' => 'back',
                    'linkTitle' => __('Back to overview', $dom),
                    'linkText' => __('Back to overview', $dom)
                );
            ...
            if ($authAdmin || (isset($uid) && isset($this->createdUserId) && $this->createdUserId == $uid)) {
                ...
                $urlArgs = array('ot' => 'event',
                                 'kind' => $this->id);
                if ($currentFunc == 'view') {
                    $urlArgs['returnTo'] = 'userViewKind';
                } elseif ($currentFunc == 'display') {
                    $urlArgs['returnTo'] = 'userDisplayKind';
                }
                $this->_actions[] = array(
     ...
     *
     * @see Weekly_Entity_Kind::postLoadCallback()
    ...
    protected function performPostLoadCallback()
    {
        ...
        $this->formatTextualField('kindName', $currentFunc, $usesCsvOutput);
        $this->formatTextualField('kindText', $currentFunc, $usesCsvOutput);
        if (!empty($this['kindPicture'])) {
            try {
                $basePath = $controllerHelper->getFileBaseFolder('kind', 'kindPicture');
            } catch (\Exception $e) {
                return LogUtil::registerError($e->getMessage());
            }
        
            $fullPath = $basePath .  $this['kindPicture'];
            $this['kindPictureFullPath'] = $fullPath;
            $this['kindPictureFullPathURL'] = System::getBaseUrl() . $fullPath;
        
            // just some backwards compatibility stuff
            /*if (!isset($this['kindPictureMeta']) || !is_array($this['kindPictureMeta']) || !count($this['kindPictureMeta'])) {
                // assign new meta data
                $this['kindPictureMeta'] = $uploadManager->readMetaDataForFile($this['kindPicture'], $fullPath);
            }*/
        }
     ...
     *
     * @see Weekly_Entity_Kind::prePersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no access to entity manager or unit of work apis
     *
     * @see Weekly_Entity_Kind::postPersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see Weekly_Entity_Kind::preRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL DELETE statement
     *
     * @see Weekly_Entity_Kind::postRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
    protected function performPostRemoveCallback()
    {
        ...
        $uploadFields = array('kindPicture');
        foreach ($uploadFields as $uploadField) {
            ...
            $uploadManager->deleteUploadFile('kind', $this, $uploadField, $objectId);
        }
     ...
     *     - no creation of other entities allowed
     *
     * @see Weekly_Entity_Kind::preUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL UPDATE statement
     *
     * @see Weekly_Entity_Kind::postUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see Weekly_Entity_Kind::preSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     * For more information see corresponding callback handlers.
     *
     * @see Weekly_Entity_Kind::postSaveCallback()
     * @return boolean true if completed successfully else false.
     */
    ...
    public function __clone()
    {
        ...
        if ($this->id) {
            ...
            $entity->setKindName($this->getKindName());
            $entity->setKindText($this->getKindText());
            $entity->setKindPicture($this->getKindPicture());
