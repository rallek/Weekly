...
class Weekly_Api_Base_Admin extends Zikula_AbstractApi
{
    ...
    public function getlinks()
    {
        ...
        if (in_array('leader', $allowedObjectTypes)
            && SecurityUtil::checkPermission($this->name . ':Leader:', '::', ACCESS_ADMIN)) {
            $links[] = array('url' => ModUtil::url($this->name, 'admin', 'view', array('ot' => 'leader')),
                             'text' => $this->__('Leaders'),
                             'title' => $this->__('Leader list'));
        }
        if (in_array('organisator', $allowedObjectTypes)
            && SecurityUtil::checkPermission($this->name . ':Organisator:', '::', ACCESS_ADMIN)) {
            $links[] = array('url' => ModUtil::url($this->name, 'admin', 'view', array('ot' => 'organisator')),
