 ...
 */
class Weekly_Form_Handler_Admin_Location_Base_Edit extends Weekly_Form_Handler_Admin_Edit
{
    /**
     * Pre-initialise hook.
     *
    ...
    public function preInitialize()
    {
        ...
        $this->uploadFields = array('locationPicture' => false);
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        if ($this->mode == 'create') {
            ...
            if (!$modelHelper->canBeCreated($this->objectType)) {
                LogUtil::registerError($this->__('Sorry, but you can not create the location yet as other items are required which must be created before!'));
