 ...
 */
class Weekly_Form_Plugin_Base_RelationSelectorAutoComplete extends Weekly_Form_Plugin_AbstractObjectSelector
{
    /**
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        switch ($this->objectType) {
            ...
            case 'kind':
                ...
                break;
            case 'location':
                $entityNameTranslated = __('location', $dom);
                break;
        }
        ...
        $createLink = '';
        if ($this->createLink != '') {
            $createLink = '<a id="' . 'SelectorDoNew" href="' . DataUtil::formatForDisplay($this->createLink) . '" title="' . __f('Create new %s', array($entityNameTranslated), $dom) . '" class="z-button weekly-inline-button">' . __('Create', $dom) . '</a>';
        }

        $alias = $this->id;

        $result = '
            <div class="weekly-relation-rightside">'
                . $addLink . '
                <div id="' . $idPrefix . 'AddFields">
                    ...
                    <div id="' . $idPrefix . 'SelectorChoices" class="weekly-autocomplete' . (($this->withImage) ? '-with-image' : '') . '"></div>
                    <input type="button" id="' . $idPrefix . 'SelectorDoCancel" name="' . $idPrefix . 'SelectorDoCancel" value="' . __('Cancel', $dom) . '" class="z-button weekly-inline-button" />'
                    . $createLink . '
