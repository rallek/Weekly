 ...
 */
class Weekly_Base_RouterFacade
{
    /**
    ...
    protected function initUrlRoutes()
    {
        ...
        $isDefaultModule = (System::getVar('shorturlsdefaultmodule', '') == 'Weekly');
    
        $defaults = array();
        $modulePrefix = '';
        if (!$isDefaultModule) {
            $defaults['module'] = 'Weekly';
            $modulePrefix = ':module/';
        }
