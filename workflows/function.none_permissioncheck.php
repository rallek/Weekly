 ...
 */
function Weekly_workflow_none_permissioncheck($obj, $permLevel, $currentUser, $actionId)
{
    ...
    $idFields = ModUtil::apiFunc('Weekly', 'selection', 'getIdFields', array('ot' => $objectType));
    $instanceId = '';
 ...
 */
function Weekly_workflow_none_gettextstrings()
{
    return array(
